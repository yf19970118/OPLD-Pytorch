...
def prepare(srcpath, dstpath):
    ...
    if not os.path.exists(os.path.join(dstpath, 'trainval_1024_ms')):
        os.makedirs(os.path.join(dstpath, 'trainval_1024_ms'))
    ...
    split_train_ms = ImgSplit_multi_process.splitbase(os.path.join(srcpath, 'train'),
                        os.path.join(dstpath, 'trainval_1024_ms'),
                        gap=200,
                        subsize=1024,
                        num_process=32)
    ...
    #                    os.path.join(dstpath, 'test_1024_ms', 'images'),
    #                   gap=200,
    #                   subsize=1024,
    #                   num_process=32
    #                   )
    ...
    DOTA2COCOTrain(os.path.join(dstpath, 'trainval_1024_ms'), os.path.join(dstpath, 'trainval_1024_ms', 'DOTA_trainval_1024_ms.json'), wordname_15, difficult='2')
    #
    # DOTA2COCOTest(os.path.join(dstpath, 'test1024'), os.path.join(dstpath, 'test1024', 'DOTA_test1024.json'), wordname_15)
    # DOTA2COCOTest(os.path.join(dstpath, 'test_1024_ms'), os.path.join(dstpath, 'test_1024_ms', 'DOTA_test_1024_ms.json'), wordname_15)
