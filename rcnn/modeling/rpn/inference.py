...
from utils.data.structures.boxlist_ops import cat_boxlist, boxlist_nms, remove_small_boxes
from rcnn.utils.box_coder import BoxCoder
from rcnn.utils.misc import permute_and_flatten
...
def make_rpn_postprocessor(rpn_box_coder, is_train):
    fpn_post_nms_top_n = cfg.RPN.FPN_POST_NMS_TOP_N_TRAIN if is_train else cfg.RPN.FPN_POST_NMS_TOP_N_TEST
    pre_nms_top_n = cfg.RPN.PRE_NMS_TOP_N_TRAIN if is_train else cfg.RPN.PRE_NMS_TOP_N_TEST
    post_nms_top_n = cfg.RPN.POST_NMS_TOP_N_TRAIN if is_train else cfg.RPN.POST_NMS_TOP_N_TEST
