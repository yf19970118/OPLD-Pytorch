...
from models.ops import smooth_l1_loss, equalization_loss
from utils.data.structures.boxlist_ops import boxlist_iou
from rcnn.datasets.dataset import get_image_count_frequency
...
class FastRCNNLossComputation(object):
    ...
    def __init__(self, proposal_matcher, fg_bg_sampler, box_coder, cls_agnostic_bbox_reg=False, cls_on=True,
        ...
        self.cls_on = cls_on
        self.reg_on = reg_on
        if cfg.FAST_RCNN.ROI_CLS_LOSS == 'eql':
            freq_info = get_image_count_frequency(cfg.MODEL.NUM_CLASSES - 1, cfg.TRAIN.DATASETS[0])
    ...
    def __call__(self, class_logits, box_regression):
        ...
        if class_logits[0] is not None:
            ...
            if cfg.FAST_RCNN.ROI_CLS_LOSS == 'cross_entropy':
                ...
                classification_loss = equalization_loss(class_logits, labels, self.freq_info)
            else:
